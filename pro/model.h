...
// Модель
class MyModel : public QAbstractTableModel  //добавление очистка
{
public:
    QList<TEvent*> lst;
    ...
    int rowCount(const QModelIndex &parent = QModelIndex()) const override //прорисовка таблицы колонки строки
    {
        return lst.size();
        Q_UNUSED( parent )
    }
    ...
    QVariant headerData(int section, Qt::Orientation orientation, int role) const  //заголовок задачи
    {
